<?php
    ...
    session_start();
    $result = $conn->query("SELECT * FROM user_details") or die($conn->error);
                ...
                <div class="table-responsive py-5">
                    <table class="table table-bordered table-hover" style='cursor: pointer'>
                        ...
                        while($data = $result->fetch_assoc()){
                            echo"
                                <tbody>
                                    <tr>
                                        ...
                                        <th>
                                        <a type='submit' name='submit' data-toggle='modal' data-target='#deleteUserModal{$data['id']}''>
                            ...
                            ";
                            echo"<div class='modal fade' id='deleteUserModal{$data['id']}' tabindex='-1' role='dialog' aria-labelledby='deleteUserModalTitle' aria-hidden='true'>
                                    <div class='modal-dialog' role='document'>
                                        <div class='modal-content'>
                                            <div class='modal-header'>
                                                <h5 class='modal-title' id='deleteUserModalTitle' style='color:black'>
                                            ...
                                            <div class='modal-footer'>
                                                <a href='includes/delete_user.inc.php?id={$data['id']}' class='btn btn-danger'>Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
