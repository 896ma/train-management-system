<?php
    ...
    session_start();
    $result = $conn->query("SELECT * FROM reservation") or die($conn->error);
                    ...
                    <table class="table table-bordered table-hover" style='cursor: pointer'>
                        ...
                        while($data = $result->fetch_assoc()){
                            echo"
                                <tbody>
                                    <tr>
                                        <th class='seatNumber' scope='row'>{$data['seatNumber']}</th>
                                        <th>{$data['schedule']}</th>
                                        <th>{$data['scheduleCode']}</th>
                                        <th>{$data['firstName']} {$data['lastName']}</th>
                                        <th>{$data['classType']}</th>
                                        <th>
                                        <a type='submit' name='submit' data-toggle='modal' id='removeReservation' data-target='#deleteReservationModal{$data['id']}''>
                            ...
                            ";
                            echo"<div class='modal fade' id='deleteReservationModal{$data['id']}' tabindex='-1' role='dialog' aria-labelledby='deleteModalTitle' aria-hidden='true'>
                                    <div class='modal-dialog' role='document'>
                                        <div class='modal-content'>
                                            <div class='modal-header'>
                                                <h5 class='modal-title' id='deleteModalTitle' style='color:black'>
                                            ...
                                            <div class='modal-footer'>
                                                <a href='includes/delete_reservation.inc.php?id={$data['id']}' class='btn btn-danger'>Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
