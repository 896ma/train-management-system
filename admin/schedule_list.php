<?php
    ...
    session_start();
    $dropresult = $conn->query("SELECT * FROM trains") or die($conn->error);
        ...
        <nav>
          ...
          <div class="card mt-2 ml-2 mr-2">
            ...
            <div class="card-body pt-0 pb-0">
                <a class='btn btn-info mt-1' style='position: absolute; margin-left: 90%;' data-toggle="modal" data-target="#createScheduleModal">
                    <strong>Create</strong>
                </a>

                <!-- Create Schedule -->
                <div class="modal fade"  id="createScheduleModal" tabindex="-1" role="dialog" aria-labelledby="createScheduleModalTitle" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="createScheduleModalTitle" style="color:black">
                                    Create New Schedule
                                </h5>
                            ...
                            <div class="modal-body">
                                <form action="includes/schedule.inc.php" method='POST'>
                                    ...
                                    <select id="trainDetails" name="trainDetails">
                                        <option selected value="">--Select Train--</option>
                                        <?php
                                            while($dropdata = $dropresult->fetch_assoc()){
                                                echo"
                                                    <option value='{$dropdata['trainCode']}-{$dropdata['trainName']}'>{$dropdata['trainCode']}-{$dropdata['trainName']}</option>
                                                ";
                                            }
                                        ?>
                                    </select>
                                    <h4 class="text-muted">Route</h4>
                                    <div class="row">
                                        <div class="col-md">
                                    ...
                                    <h4 class="text-muted">Fare</h4>
                                    <div class="row">
                                        <div class="col-md">
                                            <input type="number" min='0' name='firstClass' placeholder='FIRST CLASS (Kshs)' required>
                                        </div>
                                        <div class="col-md">
                                            <input type="number" min='0' name='economy' placeholder='ECONOMY (Kshs)' required>
                                        </div>
                                    </div>
                ...
                <div class="table-responsive py-5">
                    <table class="table table-bordered table-hover" style='cursor: pointer'>
                        ...
                        while($data = $result->fetch_assoc()){
                                        ...
                                        <th>
                                            <div class='row'>
                                                <div class='col-md ml-3'>
                                                    <a type='submit' name='submit' data-toggle='modal' data-target='#updateScheduleModal{$data['id']}'>
                                                ...
                                                <div class='col-md'>
                                                    <a type='submit' name='submit' data-toggle='modal' data-target='#deleteScheduleModal{$data['id']}''>
                            ...
                            echo"<div class='modal fade' id='updateScheduleModal{$data['id']}' tabindex='-1' role='dialog' aria-labelledby='deleteScheduleModalTitle' aria-hidden='true'>
                                    <div class='modal-dialog' role='document'>
                                        <div class='modal-content'>
                                            <div class='modal-header'>
                                                <h5 class='modal-title' id='updateScheduleModalTitle' style='color:black'>
                                                    Update {$data['scheduleTime']}
                                                </h5>
                                                <button type='button' class='close' data-dismiss='modal' aria-label='Close'>
                                                <span aria-hidden='true' style='color:black'>&times;</span>
                                                </button>
                                            ...
                                            <div class='modal-body'>
                                                <form action='includes/update_schedule.inc.php' method='POST'>
                                                    <h4 class='text-muted'>Schedule</h4>
                                                    ...
                                                    <div class='row'>
                                                        <div class='col-md'>
                                                            <input type='text' name='from' value='{$data['routefrom']}' required>
                                                        </div>
                                                        <div class='col-md'>
                                                            <input type='text' name='to' value='{$data['routeto']}' required>
                                                        </div>
                                                    </div>
                                                    <h4 class='text-muted'>Fare</h4>
                                                    <div class='row'>
                                                        <div class='col-md'>
                                                            <input type='number' min='0' name='firstClass' value='{$data['firstClass']}' required>
                                                        </div>
                                                        <div class='col-md'>
                                                            <input type='number' min='0' name='economy' value='{$data['economy']}' required>
                                                        </div>
                                                    </div>
                                                    <div class='modal-footer mt-4'>
                            ...
                            echo"<div class='modal fade' id='deleteScheduleModal{$data['id']}' tabindex='-1' role='dialog' aria-labelledby='deleteScheduleModalTitle' aria-hidden='true'>
                                    <div class='modal-dialog' role='document'>
                                        <div class='modal-content'>
                                            <div class='modal-header'>
                                                <h5 class='modal-title' id='deleteScheduleModalTitle' style='color:black'>
                                            ...
                                            <div class='modal-footer'>
                                                <a href='includes/delete_schedule.inc.php?id={$data['id']}' class='btn btn-danger'>Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="side-navbar active-nav d-flex justify-content-between flex-wrap flex-column" id="sidebar">
                    <ul class="nav flex-column  w-100 text-white">
                        <a href="#" class="nav-link h3 my-2">
                            ...
                            <br>
                            <span style="font-size: .9rem;">Schedule Management System</span>
                            </center>
